...
public class SimpleMonthView extends View {
    ...
    /**
     * Called when the user clicks on a day. Handles callbacks to the {@link com.doomonafireball.betterpickers.calendardatepicker.SimpleMonthView.OnDayClickListener} if one is set.
     *
